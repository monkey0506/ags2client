...
namespace AGS2Client
{
    ...
    public:
        ...
        virtual void AttemptDefaultInitialization() const = 0;
        virtual char const* GetAGSScriptHeader(float version = 1.0f) const;
        ...
        virtual char const* GetInitializeSignatureForScriptHeader() const;
